        ...
        return {
            airData: [
                ...
                
                {
                    id: 2,
                    name: 'Ezbreeze',
                    picture:  require('../assets/image/air/EZB.png'),
                    logo: require('../assets/image/air/EZBLogo.png'),
                    link: 'https://www.esplma.com/7QLQCMW/5GTH4TX/?uid=7575',
                    reviewLink: 'https://www.esplma.com/7QLQCMW/5GTH4TX/?uid=7561',
                    rate: '9.6',
                    desc: '<p style="font-size:20px;"><strong><span style="color:#F96E35;">Limited Time Offer: </span>Get 50% OFF plus Free Delivery</strong></p>',
                    list: [
                        {
                            text: 'Works as a humidifier'
                        },
                        {
                            text: 'Filters dust particles in the air'
                        },
                        {
                            text: 'Guaranteed high quality'
                        },
                        {
                            text: 'No-hassle returns'
                        },
                        {
                            text: 'Completely portable'
                        },
                        {
                            text: 'Cord-free operation'
                        }
